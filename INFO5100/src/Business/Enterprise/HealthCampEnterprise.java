 ...
 */
public class HealthCampEnterprise extends Enterprise {
    ...
    public HealthCampEnterprise(String name) {
        super(name, Enterprise.EnterpriseType.Camp);
    }

    public HealthCampEnterprise(String name, String street, String city, String state, String zipcode, String peopleAffected, String percentChild, String percentElder, int campId, Date eventDate, String campHospital) {
        super(name, Enterprise.EnterpriseType.Camp);
        this.street = street;
        this.city = city;
        this.state = state;
