 ...
 */
public class FundCharityEnterprise extends Enterprise {
    ...
    public FundCharityEnterprise(String name) {
        super(name, Enterprise.EnterpriseType.Event);
    }

    public FundCharityEnterprise(String name, String street, String city, String state, String zipcode, Date eventDate, Enterprise.EnterpriseType type, int budgetCount) {
        super(name, Enterprise.EnterpriseType.Event);
        this.street = street;
        this.city = city;
        this.state = state;
